...
function toSnapshot(row: Record<string, unknown>): TractionSnapshot {
  return {
    ...
    onchainDailyTxCount: row.onchain_daily_tx_count as number | undefined,
    onchainWeeklyTxCount: row.onchain_weekly_tx_count as number | undefined,
    onchainDailyVolume: row.onchain_daily_volume as string | undefined,
    onchainWeeklyVolume: row.onchain_weekly_volume as string | undefined,
    onchainDailyActiveAddresses: row.onchain_daily_active_addresses as number | undefined,
    onchainWeeklyActiveAddresses: row.onchain_weekly_active_addresses as number | undefined,
