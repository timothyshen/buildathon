      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-muted-foreground">
            SWA.XYZ transforms buildathon submissions into registered IP assets on Story Protocol.
            Every project becomes a forkable template that builders can extend, customize, and monetize.
          </p>
